...
public class ProjectService {
  ...
  public Page<GetAllProjectsDto> getAllProjects(Pageable pageable) {
    ...
    public ProjectResponseDto getProjectById(String projectId) {
        ...
        ProjectEntity projectEntity = projectRepository.findBy(projectId)
                .orElseThrow(() -> {
                    ...
                    return new ApplicationException(HttpStatus.NOT_FOUND, "Project not found with ID: " + projectId);
                });
    ...
    public ProjectResponseDto getProjectByUrl(String url) {
        ...
        ProjectEntity projectEntity = projectRepository.findByProjectUrl(url)
                .orElseThrow(() -> {
                    ...
                    return new ApplicationException(HttpStatus.NOT_FOUND, "Project with URL " + url + " not found.");
                });
    ...
    public ProjectResponseDto getProjectByTitle(String title) {
        ...
        ProjectEntity projectEntity = projectRepository.findByTitle(title)
                .orElseThrow(() -> {
                    log.warn("Project with title {} not found.", title);
                    return new ApplicationException(HttpStatus.NOT_FOUND,
                            "Project with title " + title + " not found.");
                });
